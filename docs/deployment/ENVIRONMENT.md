...
| `VAPID_PUBLIC_KEY`                     | secreto servidor |        push | par VAPID para Web Push                                     |
| `VAPID_PRIVATE_KEY`                    | secreto servidor |        push | par VAPID para Web Push                                     |
| `VAPID_SUBJECT`                        | servidor         |        push | `mailto:` de contacto exigido por push services             |
| `NEXT_PUBLIC_VAPID_PUBLIC_KEY`         | público          |        push | clave pública expuesta al cliente (`pushManager.subscribe`) |
