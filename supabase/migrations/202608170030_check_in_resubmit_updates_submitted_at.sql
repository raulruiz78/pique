-- submit_check_in (202608160028) reutiliza el check_in existente al
-- reenviar tras un rechazo, pero no actualizaba submitted_at: la fecha de
-- envío se quedaba congelada en el primer intento, así que cualquier
-- pantalla que muestre "cuándo se envió" mentía tras un reenvío. Se
-- necesita trazabilidad real (pedido explícito: "que las validaciones
-- tengan más trazabilidad"), así que cada reenvío ahora cuenta como un
-- nuevo envío también en submitted_at.
